...
func (db *DB) Migrate() error {
	...
	for _, migration := range migrations {
		...
		execMigration := func(tx utils.Transaction) error {
...
func doTransaction(sqlDB *sql.DB, txFunc func(utils.Transaction) error) error {
	tx, err := sqlDB.Begin()
	if err != nil {
		return err
	}
